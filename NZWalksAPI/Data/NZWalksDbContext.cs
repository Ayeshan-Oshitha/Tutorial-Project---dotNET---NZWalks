    ...
    public class NZWalksDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var difficulties = new List<Difficulty>()
            {
                ...
                new Difficulty()
                {
                    Id = Guid.Parse("cf976084-7ce5-458b-bf98-166bee4e666f") ,
                    Name = "Easy"
                },

                 new Difficulty()
                {
                    Id = Guid.Parse("d1e47ffe-5c35-4de0-8ae5-26f18adc7e1b"),
                    Name = "Medium"
                },

                  new Difficulty()
                {
                    Id = Guid.Parse("bd6bcc51-8305-4df9-917c-900c13014c03") ,
                    Name = "Hard"
                },
            };
